...
const SW_VERSION       = 'v2'; // bumped for the new S/map-pin icon + splash branding —
                                 // new cache names force a clean asset refresh instead of
                                 // silently reusing the old cache contents
...
// Icon URLs carry a ?v=2 cache-busting query string (bumped alongside the
