...
const SW_VERSION       = 'v3'; // bumped: icon artwork re-exported with a much larger
                                 // foreground fill (was too small/padded on Android
                                 // launchers) — new cache name forces a clean refresh
