...
const SW_VERSION       = 'v4'; // bumped: pinch-to-zoom image viewer shipped
                                 // (touch-action rules in app.css + new lightbox
                                 // JS) — new cache name forces a clean refresh so
                                 // devices stop serving the pre-zoom app.css
